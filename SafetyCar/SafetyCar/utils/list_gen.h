...
#ifndef SOURCE_SRC_UTILS_LIST_GEN_H_
#define SOURCE_SRC_UTILS_LIST_GEN_H_

#include <stddef.h>
#include <stdbool.h>
#include <utils/utility_macros.h>
//There Is meta code and then the is META code
...
#endif /* SOURCE_SRC_UTILS_LIST_GEN_H_ */
